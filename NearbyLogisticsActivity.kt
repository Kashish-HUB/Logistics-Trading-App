...
class NearbyLogisticsActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_nearby_logistics)
    ...
    private fun showNearbyProviders(userGeoPoint: GeoPoint) {
        val providers = List(5) {
            GeoPoint(
                userGeoPoint.latitude + Random.nextDouble(-0.02, 0.02),
                userGeoPoint.longitude + Random.nextDouble(-0.02, 0.02)
            )
        }
